...
void setup() {
  ...
  cp5.addTextfield("cal_target").setPosition(xPosA + 970, buttonPositionY * 2.42).setSize(100, 35).setFont(font).setFocus(true).setColor(color(200,200,200));
  ...
  cp5.addButton("High Fat")
    .setPosition(buttonPositionX + 500, buttonPositionY * 2.35)
    .setSize(150, 30)
    .setId(5);
    
  cp5.addButton("Heavy and Filling")
    .setPosition(buttonPositionX + 500, buttonPositionY * 2.53)
    .setSize(150, 30)
    .setId(6);
    
  cp5.addButton("Just Right for Me")
    .setPosition(buttonPositionX + 500, buttonPositionY * 2.63)
    .setSize(150, 30)
    .setId(7);
    
  cp5.addButton("Light and Not Filling")
    .setPosition(buttonPositionX + 500, buttonPositionY * 2.73)
    .setSize(150, 30)
    .setId(8);
  ...
  cp5.addButton("Skip")
    .setPosition(buttonPositionX + 860, buttonPositionY * 2.6)
    .setSize(163, 30)
    .setId(12);
    
  cp5.addButton("Submit")
    .setPosition(buttonPositionX + 860, buttonPositionY * 2.7)
    .setSize(163, 30)
    .setId(13);   
...
void draw() {
  ...
  text("What do you think about this dish?" + "\n" + title + " with " + nutri_info + " kCal", xPosA, yPosA + ySpacing + 80);
  ...
  text("Why would you eat this meal? (Pick One)", xPosA + 422, yPosA + ySpacing + 160);
  
  text("Is this meal,", xPosA + 455, yPosA * 3.61);
  ...
  text("Not\nVery\nEnergetic", xPosA, yPosA * 4.12);
  text("As\nNormal", xPosA + 148, yPosA * 4.12);
  text("Very\nEnergetic", xPosA + 296, yPosA * 4.12);
  ...
  text(calMaxResult, xPosA + 768, yPosA + ySpacing + 300);
  text("What is your target calory\nfor this meal?", xPosA + 768, yPosA + ySpacing + 350);
